...
You need to specify the maximum number of total ISAs (`nMaxIntr`) and the number of ISAs starting at platform initiation (`nStartIntr`). The function then adds an intervention whenever an ISA leaves until the maximum number is reached.
For example: 
